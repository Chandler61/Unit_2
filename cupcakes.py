...
# my_cupcake = Cupcake("Vanilla", 4.99, "Vanilla", "White", "Chocolate")
# my_cupcake.frosting = "Chocolate"
# my_cupcake.filling = "Chocolate"
# my_cupcake.name = "Triple Chocolate"
# my_cupcake.add_sprinkles("Red", "Blue", "White")
# print(my_cupcake)
class Mini(Cupcake):
    size = "mini"
    ...
    def calculate_price(self, quantity):
        return quantity * self.price
# my_cupcake_mini = Mini("Chocolate", 2.99, "Chocolate", "Vanilla")
